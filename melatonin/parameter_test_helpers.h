...
{
    // Since we're currently not using parameter helpers this has been removed to support later
    // versions of JUCE juce::MessageManager::getInstance ()->runDispatchLoopUntil (1);
